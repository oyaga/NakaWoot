...
export function ContactDetails() {
  ...
  if (!contact) return <div className="w-80 border-l bg-white"></div>;
...
<AccordionTrigger className="px-4 text-xs font-semibold uppercase text-slate-500">
...
<div className="bg-slate-50 p-2 rounded text-[11px] font-mono">

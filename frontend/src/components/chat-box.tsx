...
console.log('Enviando para Go:', message);
...
<Button size="sm" className="text-xs bg-green-600 hover:bg-green-700">Resolver</Button>
</div>
</header>
...
<div className="bg-white border rounded-2xl rounded-tl-none p-4 max-w-[70%] text-sm shadow-sm leading-relaxed">
...
<div className="flex-1 bg-slate-100 rounded-xl p-2 flex items-center space-x-2 focus-within:ring-1 focus-within:ring-blue-500 transition-all">
...
<Button onClick={handleSendMessage} size="icon" className="rounded-xl h-10 w-10 bg-blue-600 hover:bg-blue-700 shrink-0">
<Send size={18} />
</Button>
</div>
</footer>

...
<span className="text-[10px] text-slate-500 font-bold uppercase tracking-tighter">WhatsApp</span>
...
<span className={cn(
"text-[10px] font-bold",
health.is_online ? "text-slate-300" : "text-red-400"
)}>
...
"h-4 w-4",
health.battery_level < 20 ? "text-red-500" : "text-green-500"
)} />
